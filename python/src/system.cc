...
void pynexus::init_system_bindings(py::module &m) {
  ...
  py::class_<Buffer>(m, "_buffer", py::module_local())
      .def("__bool__", [](Buffer &self) { return (bool)self; })
  ...
  py::class_<Kernel>(m, "_kernel", py::module_local())
      .def("__bool__", [](Kernel &self) { return (bool)self; })
      .def("get_property_str", [](Kernel &self, const std::string &name) {
        // auto prop = nxsGetPropEnum(name.c_str());
        // return self.getProperty<std::string>(prop);
        return std::string();
      });
  ...
  py::class_<Library>(m, "_library", py::module_local())
      .def("__bool__", [](Library &self) { return (bool)self; })
      .def("get_property_str",
  ...
  py::class_<Command>(m, "_command", py::module_local())
      .def("__bool__", [](Command &self) { return (bool)self; })
      .def("get_property_str",
  ...
  py::class_<Schedule>(m, "_schedule", py::module_local())
      .def("__bool__", [](Schedule &self) { return (bool)self; })
      .def("get_property_str",
  ...
  py::class_<Device>(m, "_device", py::module_local())
      .def("__bool__", [](Device &self) { return (bool)self; })
      .def("get_property_str",
  ...
  py::class_<Devices>(m, "_devices", py::module_local())
      ...
      .def("size", [](Devices &self) { return self.size(); })
      .def("__getitem__", [](Devices &self, int idx) { return self.get(idx); });

  py::class_<Runtime>(m, "_runtime", py::module_local())
      .def("__bool__", [](Runtime &self) { return (bool)self; })
      .def("get_device",
      ...
      .def("get_property_int", [](Runtime &self, nxs_property prop) {
        return self.getProp<nxs_long>(prop);
      });
  ...
  py::class_<Runtimes>(m, "_runtimes", py::module_local())
      .def(
          ...
          py::keep_alive<0, 1>() /* Essential: keep object alive */)
      .def("size", [](Runtimes &self) { return self.size(); })
      .def("__getitem__",
           [](Runtimes &self, int idx) { return self.get(idx); });
